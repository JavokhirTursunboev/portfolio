...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* ======== SOCIAL MEDIA ======= */}
      <div className="hidden md:flex gap-4 w-1/3">
        <Link href="https://github.com/JavokhirTursunboev" target='_blank'>
        ...
        <Link href="https://www.linkedin.com/in/javokhir-tursunboev/" target='_blank'>
        ...
        <Link href="https://t.me/JavohirEngineer" target='_blank'>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
        ...
        <Link href="mailTo:hijavokhir@gmail.com" target='_blank'>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
